...
const irregularVerbs = [
    ...
    // Verbos adicionales comunes (completando la lista)
    { base: "arise", past: "arose", participle: "arisen", meaning: "surgir" },
    { base: "behold", past: "beheld", participle: "beheld", meaning: "contemplar" },
    { base: "bind", past: "bound", participle: "bound", meaning: "atar" },
    { base: "breed", past: "bred", participle: "bred", meaning: "criar" },
    { base: "cling", past: "clung", participle: "clung", meaning: "aferrarse" },
    { base: "creep", past: "crept", participle: "crept", meaning: "arrastrarse" },
    { base: "deal", past: "dealt", participle: "dealt", meaning: "tratar" },
    { base: "flee", past: "fled", participle: "fled", meaning: "huir" },
    { base: "fling", past: "flung", participle: "flung", meaning: "lanzar" },
    { base: "grind", past: "ground", participle: "ground", meaning: "moler" },
    { base: "kneel", past: "knelt", participle: "knelt", meaning: "arrodillarse" },
    { base: "lead", past: "led", participle: "led", meaning: "guiar" },
    { base: "lean", past: "leant/leaned", participle: "leant/leaned", meaning: "apoyarse" },
    { base: "leap", past: "leapt/leaped", participle: "leapt/leaped", meaning: "saltar" },
    { base: "mislead", past: "misled", participle: "misled", meaning: "engañar" },
    { base: "overcome", past: "overcame", participle: "overcome", meaning: "superar" },
    { base: "overtake", past: "overtook", participle: "overtaken", meaning: "adelantar" },
    { base: "rid", past: "rid", participle: "rid", meaning: "librar" },
    { base: "seek", past: "sought", participle: "sought", meaning: "buscar" },
    { base: "set", past: "set", participle: "set", meaning: "poner/establecer" },
    { base: "shed", past: "shed", participle: "shed", meaning: "derramar" },
    { base: "shrink", past: "shrank", participle: "shrunk", meaning: "encoger" },
    { base: "slay", past: "slew", participle: "slain", meaning: "matar" },
    { base: "slide", past: "slid", participle: "slid", meaning: "deslizar" },
    { base: "sling", past: "slung", participle: "slung", meaning: "lanzar" },
    { base: "slit", past: "slit", participle: "slit", meaning: "cortar" },
    { base: "sow", past: "sowed", participle: "sown", meaning: "sembrar" },
    { base: "spin", past: "spun", participle: "spun", meaning: "girar" },
    { base: "spit", past: "spat", participle: "spat", meaning: "escupir" },
    { base: "stride", past: "strode", participle: "stridden", meaning: "dar zancadas" },
    { base: "strike", past: "struck", participle: "struck", meaning: "golpear" },
    { base: "strive", past: "strove", participle: "striven", meaning: "esforzarse" },
    { base: "swear", past: "swore", participle: "sworn", meaning: "jurar" },
    { base: "swell", past: "swelled", participle: "swollen", meaning: "hinchar" },
    { base: "thrive", past: "throve", participle: "thriven", meaning: "prosperar" },
    { base: "tread", past: "trod", participle: "trodden", meaning: "pisar" },
    { base: "undergo", past: "underwent", participle: "undergone", meaning: "sufrir" },
    { base: "uphold", past: "upheld", participle: "upheld", meaning: "mantener" },
    { base: "weave", past: "wove", participle: "woven", meaning: "tejer" },
    { base: "weep", past: "wept", participle: "wept", meaning: "llorar" },
    { base: "wind", past: "wound", participle: "wound", meaning: "enrollar" },
    { base: "withdraw", past: "withdrew", participle: "withdrawn", meaning: "retirar" },
    { base: "wring", past: "wrung", participle: "wrung", meaning: "retorcer" }
];
// Variables globales
let selectedVerbs = [];
